...
#include "act_mov_pkg/action/detail/navigate__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_act_mov_pkg
cdr_serialize(
  const act_mov_pkg::action::Navigate_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  act_mov_pkg::action::Navigate_Goal & ros_message)
{
  // Member: goal_point
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = act_mov_pkg::action::Navigate_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const act_mov_pkg::action::Navigate_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<act_mov_pkg::action::Navigate_Goal *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_act_mov_pkg
const rosidl_message_type_support_t *
get_message_type_support_handle<act_mov_pkg::action::Navigate_Goal>()
{
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, act_mov_pkg, action, Navigate_Goal)() {
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_act_mov_pkg
cdr_serialize(
  const act_mov_pkg::action::Navigate_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: elpased_time
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  act_mov_pkg::action::Navigate_Result & ros_message)
{
  // Member: elpased_time
  cdr >> ros_message.elpased_time;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = act_mov_pkg::action::Navigate_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const act_mov_pkg::action::Navigate_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<act_mov_pkg::action::Navigate_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, act_mov_pkg, action, Navigate_Result)() {
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_act_mov_pkg
cdr_serialize(
  const act_mov_pkg::action::Navigate_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  act_mov_pkg::action::Navigate_Feedback & ros_message)
{
  // Member: distance_to_point
  cdr >> ros_message.distance_to_point;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = act_mov_pkg::action::Navigate_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const act_mov_pkg::action::Navigate_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<act_mov_pkg::action::Navigate_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, act_mov_pkg, action, Navigate_Feedback)() {
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_Feedback__handle;
}
...
// functions for act_mov_pkg::action::Navigate_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_act_mov_pkg
cdr_serialize(
  const act_mov_pkg::action::Navigate_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  ...
  // Member: goal
  act_mov_pkg::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  act_mov_pkg::action::Navigate_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  act_mov_pkg::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  current_alignment +=
    act_mov_pkg::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = act_mov_pkg::action::Navigate_SendGoal_Request;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: goal
  act_mov_pkg::action::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.goal,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  current_alignment +=
    act_mov_pkg::action::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.goal, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_key_Navigate_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const act_mov_pkg::action::Navigate_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<act_mov_pkg::action::Navigate_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, act_mov_pkg, action, Navigate_SendGoal_Request)() {
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_act_mov_pkg
cdr_serialize(
  const act_mov_pkg::action::Navigate_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  act_mov_pkg::action::Navigate_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = act_mov_pkg::action::Navigate_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const act_mov_pkg::action::Navigate_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<act_mov_pkg::action::Navigate_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, act_mov_pkg, action, Navigate_SendGoal_Response)() {
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Response__handle;
}
...
// functions for act_mov_pkg::action::Navigate_SendGoal_Request already declared above

// functions for act_mov_pkg::action::Navigate_SendGoal_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_act_mov_pkg
cdr_serialize(
  const act_mov_pkg::action::Navigate_SendGoal_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  act_mov_pkg::action::Navigate_SendGoal_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = act_mov_pkg::action::Navigate_SendGoal_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_key_Navigate_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_key_Navigate_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const act_mov_pkg::action::Navigate_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<act_mov_pkg::action::Navigate_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, act_mov_pkg, action, Navigate_SendGoal_Event)() {
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Event__handle;
}
...
static const rosidl_service_type_support_t _Navigate_SendGoal__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<act_mov_pkg::action::Navigate_SendGoal_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<act_mov_pkg::action::Navigate_SendGoal_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<act_mov_pkg::action::Navigate_SendGoal_Event>(),
...
{
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, act_mov_pkg, action, Navigate_SendGoal)() {
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_act_mov_pkg
cdr_serialize(
  const act_mov_pkg::action::Navigate_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  act_mov_pkg::action::Navigate_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = act_mov_pkg::action::Navigate_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const act_mov_pkg::action::Navigate_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<act_mov_pkg::action::Navigate_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, act_mov_pkg, action, Navigate_GetResult_Request)() {
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for act_mov_pkg::action::Navigate_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_act_mov_pkg
cdr_serialize(
  const act_mov_pkg::action::Navigate_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  act_mov_pkg::action::Navigate_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = act_mov_pkg::action::Navigate_GetResult_Response;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_key_Navigate_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const act_mov_pkg::action::Navigate_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<act_mov_pkg::action::Navigate_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, act_mov_pkg, action, Navigate_GetResult_Response)() {
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Response__handle;
}
...
// functions for act_mov_pkg::action::Navigate_GetResult_Request already declared above

// functions for act_mov_pkg::action::Navigate_GetResult_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_act_mov_pkg
cdr_serialize(
  const act_mov_pkg::action::Navigate_GetResult_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  service_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  act_mov_pkg::action::Navigate_GetResult_Event & ros_message)
{
  // Member: info
  service_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.info);
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = act_mov_pkg::action::Navigate_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_key_Navigate_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_key_Navigate_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const act_mov_pkg::action::Navigate_GetResult_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<act_mov_pkg::action::Navigate_GetResult_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, act_mov_pkg, action, Navigate_GetResult_Event)() {
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Event__handle;
}
...
static const rosidl_service_type_support_t _Navigate_GetResult__handle{
  ...
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<act_mov_pkg::action::Navigate_GetResult_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<act_mov_pkg::action::Navigate_GetResult_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<act_mov_pkg::action::Navigate_GetResult_Event>(),
...
{
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, act_mov_pkg, action, Navigate_GetResult)() {
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_GetResult__handle;
}
...
// functions for act_mov_pkg::action::Navigate_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_act_mov_pkg
cdr_serialize(
  const act_mov_pkg::action::Navigate_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  act_mov_pkg::action::Navigate_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = act_mov_pkg::action::Navigate_FeedbackMessage;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        act_mov_pkg::action::typesupport_fastrtps_cpp::max_serialized_size_key_Navigate_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const act_mov_pkg::action::Navigate_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<act_mov_pkg::action::Navigate_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, act_mov_pkg, action, Navigate_FeedbackMessage)() {
  return &act_mov_pkg::action::typesupport_fastrtps_cpp::_Navigate_FeedbackMessage__handle;
}
