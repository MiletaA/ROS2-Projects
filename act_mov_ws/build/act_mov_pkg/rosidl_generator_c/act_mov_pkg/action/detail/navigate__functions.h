...
// IWYU pragma: private, include "act_mov_pkg/action/navigate.h"


#ifndef ACT_MOV_PKG__ACTION__DETAIL__NAVIGATE__FUNCTIONS_H_
#define ACT_MOV_PKG__ACTION__DETAIL__NAVIGATE__FUNCTIONS_H_
...
#include "act_mov_pkg/msg/rosidl_generator_c__visibility_control.h"

#include "act_mov_pkg/action/detail/navigate__struct.h"

/// Retrieve pointer to the hash of the description of this type.
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
act_mov_pkg__action__Navigate__get_individual_type_description_source(
  const rosidl_action_type_support_t * type_support);
 ...
 * )) before or use
 * act_mov_pkg__action__Navigate_Goal__create()
 ...
 * calls
 * act_mov_pkg__action__Navigate_Goal__init().
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_Goal__fini()
...
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
const rosidl_runtime_c__type_description__TypeSource *
act_mov_pkg__action__Navigate_Goal__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
 ...
 * act_mov_pkg__action__Navigate_Goal__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_Goal__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * act_mov_pkg__action__Navigate_Result__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * act_mov_pkg__action__Navigate_Result__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_Result__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
const rosidl_runtime_c__type_description__TypeSource *
act_mov_pkg__action__Navigate_Result__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * act_mov_pkg__action__Navigate_Result__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_Result__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * act_mov_pkg__action__Navigate_Feedback__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * act_mov_pkg__action__Navigate_Feedback__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_Feedback__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
const rosidl_runtime_c__type_description__TypeSource *
act_mov_pkg__action__Navigate_Feedback__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * act_mov_pkg__action__Navigate_Feedback__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_Feedback__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
const rosidl_runtime_c__type_description__TypeSource *
act_mov_pkg__action__Navigate_SendGoal__get_individual_type_description_source(
  const rosidl_service_type_support_t * type_support);
 ...
 * )) before or use
 * act_mov_pkg__action__Navigate_SendGoal_Request__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * act_mov_pkg__action__Navigate_SendGoal_Request__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_SendGoal_Request__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
const rosidl_runtime_c__type_description__TypeSource *
act_mov_pkg__action__Navigate_SendGoal_Request__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * act_mov_pkg__action__Navigate_SendGoal_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_SendGoal_Request__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * act_mov_pkg__action__Navigate_SendGoal_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * act_mov_pkg__action__Navigate_SendGoal_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_SendGoal_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
const rosidl_runtime_c__type_description__TypeSource *
act_mov_pkg__action__Navigate_SendGoal_Response__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * act_mov_pkg__action__Navigate_SendGoal_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_SendGoal_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * act_mov_pkg__action__Navigate_SendGoal_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * act_mov_pkg__action__Navigate_SendGoal_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_SendGoal_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
const rosidl_runtime_c__type_description__TypeSource *
act_mov_pkg__action__Navigate_SendGoal_Event__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * act_mov_pkg__action__Navigate_SendGoal_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_SendGoal_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
const rosidl_runtime_c__type_description__TypeSource *
act_mov_pkg__action__Navigate_GetResult__get_individual_type_description_source(
  const rosidl_service_type_support_t * type_support);
 ...
 * )) before or use
 * act_mov_pkg__action__Navigate_GetResult_Request__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * act_mov_pkg__action__Navigate_GetResult_Request__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_GetResult_Request__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
const rosidl_runtime_c__type_description__TypeSource *
act_mov_pkg__action__Navigate_GetResult_Request__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * act_mov_pkg__action__Navigate_GetResult_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_GetResult_Request__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * act_mov_pkg__action__Navigate_GetResult_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * act_mov_pkg__action__Navigate_GetResult_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_GetResult_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
const rosidl_runtime_c__type_description__TypeSource *
act_mov_pkg__action__Navigate_GetResult_Response__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * act_mov_pkg__action__Navigate_GetResult_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_GetResult_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * act_mov_pkg__action__Navigate_GetResult_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * act_mov_pkg__action__Navigate_GetResult_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_GetResult_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
const rosidl_runtime_c__type_description__TypeSource *
act_mov_pkg__action__Navigate_GetResult_Event__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * act_mov_pkg__action__Navigate_GetResult_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_GetResult_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * act_mov_pkg__action__Navigate_FeedbackMessage__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * act_mov_pkg__action__Navigate_FeedbackMessage__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_FeedbackMessage__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
const rosidl_runtime_c__type_description__TypeSource *
act_mov_pkg__action__Navigate_FeedbackMessage__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * act_mov_pkg__action__Navigate_FeedbackMessage__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_act_mov_pkg
...
/**
 * It calls
 * act_mov_pkg__action__Navigate_FeedbackMessage__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ACT_MOV_PKG__ACTION__DETAIL__NAVIGATE__FUNCTIONS_H_
