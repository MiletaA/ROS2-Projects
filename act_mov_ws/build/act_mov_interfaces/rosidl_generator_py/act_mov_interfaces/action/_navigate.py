...
class Metaclass_Navigate_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('act_mov_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'act_mov_interfaces.action.Navigate_Goal')
            logger.debug(
...
class Metaclass_Navigate_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'act_mov_interfaces.action.Navigate_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_Result(metaclass=Metaclass_Navigate_Result):
    ...
    def __init__(self, **kwargs):
        ...
        if self._check_fields:
            assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
                'Invalid arguments passed to constructor: %s' % \
                ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.elpased_time = kwargs.get('elpased_time', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.elpased_time != other.elpased_time:
            return False
        return True
    ...
    @builtins.property
    def elpased_time(self):
        """Message field 'elpased_time'."""
        return self._elpased_time

    @elpased_time.setter
    def elpased_time(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'elpased_time' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'elpased_time' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._elpased_time = value
...
class Metaclass_Navigate_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'act_mov_interfaces.action.Navigate_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Navigate_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from act_mov_interfaces.action import Navigate
...
class Navigate_SendGoal_Request(metaclass=Metaclass_Navigate_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'act_mov_interfaces/Navigate_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['act_mov_interfaces', 'action'], 'Navigate_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from act_mov_interfaces.action._navigate import Navigate_Goal
...
class Navigate_SendGoal_Event(metaclass=Metaclass_Navigate_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<act_mov_interfaces/Navigate_SendGoal_Request, 1>',
        'response': 'sequence<act_mov_interfaces/Navigate_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['act_mov_interfaces', 'action'], 'Navigate_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['act_mov_interfaces', 'action'], 'Navigate_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from act_mov_interfaces.action import Navigate_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from act_mov_interfaces.action import Navigate_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Navigate_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'act_mov_interfaces.action.Navigate_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from act_mov_interfaces.action import _navigate
...
class Navigate_SendGoal(metaclass=Metaclass_Navigate_SendGoal):
    from act_mov_interfaces.action._navigate import Navigate_SendGoal_Request as Request
    from act_mov_interfaces.action._navigate import Navigate_SendGoal_Response as Response
    from act_mov_interfaces.action._navigate import Navigate_SendGoal_Event as Event
...
class Navigate_GetResult_Response(metaclass=Metaclass_Navigate_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'act_mov_interfaces/Navigate_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['act_mov_interfaces', 'action'], 'Navigate_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from act_mov_interfaces.action._navigate import Navigate_Result
...
class Navigate_GetResult_Event(metaclass=Metaclass_Navigate_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<act_mov_interfaces/Navigate_GetResult_Request, 1>',
        'response': 'sequence<act_mov_interfaces/Navigate_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['act_mov_interfaces', 'action'], 'Navigate_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['act_mov_interfaces', 'action'], 'Navigate_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from act_mov_interfaces.action import Navigate_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from act_mov_interfaces.action import Navigate_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Navigate_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'act_mov_interfaces.action.Navigate_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_GetResult(metaclass=Metaclass_Navigate_GetResult):
    from act_mov_interfaces.action._navigate import Navigate_GetResult_Request as Request
    from act_mov_interfaces.action._navigate import Navigate_GetResult_Response as Response
    from act_mov_interfaces.action._navigate import Navigate_GetResult_Event as Event
...
class Metaclass_Navigate_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'act_mov_interfaces.action.Navigate_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_FeedbackMessage(metaclass=Metaclass_Navigate_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'act_mov_interfaces/Navigate_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['act_mov_interfaces', 'action'], 'Navigate_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from act_mov_interfaces.action._navigate import Navigate_Feedback
...
class Metaclass_Navigate(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'act_mov_interfaces.action.Navigate')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate(metaclass=Metaclass_Navigate):
    ...
    from act_mov_interfaces.action._navigate import Navigate_Goal as Goal
    # The result message defined in the action definition.
    from act_mov_interfaces.action._navigate import Navigate_Result as Result
    # The feedback message defined in the action definition.
    from act_mov_interfaces.action._navigate import Navigate_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from act_mov_interfaces.action._navigate import Navigate_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from act_mov_interfaces.action._navigate import Navigate_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from act_mov_interfaces.action._navigate import Navigate_FeedbackMessage as FeedbackMessage
